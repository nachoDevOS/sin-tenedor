...
@section('content')
    ...
    <div class="report-header">
        ...
        <div class="title-container">
            ...
            <h2 class="report-subtitle">REPORTE DE INGRESOS DE ITEMS DISPONIBLE PARA VENTA</h2>
            <p class="report-date">
                @if ($start == $finish)
