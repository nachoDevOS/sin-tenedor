                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-hover" id="dataTable">
                                <tr>
                                    <td><h4>Dinero abonado</h4></td>
                                    <td style="text-align: right"><h4>{{ number_format($cashierInput, 2, ',', '.') }}</h4></td>
                                </tr>
                                <tr>
                                    <td><h4>Cobros realizados en efectivo</h4></td>
                                    {{-- <td style="text-align: right"><h4>{{ number_format($loanPaymentCash+$pawnPaymentCash+$salePaymentCash +$salaryPurchasePaymentCash, 2, ',', '.') }}</h4></td> --}}
                                </tr>
                                <tr>
                                    <td><h4>Cobros realizados mediante QR</h4></td>
                                    {{-- <td style="text-align: right"><h4>{{ number_format($loanPaymentQr+$pawnPaymentQr+$salePaymentQr + $salaryPurchasePaymentQr, 2, ',', '.') }}</h4></td> --}}
                                </tr>
                                {{-- <tr>
                                ...
                                <tr style="background-color: #E5E8E8">
                                    <td><h4>Dinero en efectivo disponible</h4></td>
                                    {{-- <td style="text-align: right"><h4>{{ number_format($cashierInput + $loanPaymentCash +$pawnPaymentCash + $salePaymentCash + $salaryPurchasePaymentCash - $loanCash - $extraExpenseCash - $transferAmountCash - $pawnCash - $amountAditionalCash - $salaryPurchaseCash, 2, ',', '.') }}</h4></td> --}}
                                </tr>
                                @if ($cashier->amount)
                                    <tr style="background-color: #E5E8E8">
                                        <td><h4>Dinero en efectivo al cerrar caja</h4></td>
                                        <td style="text-align: right"><h4>{{ number_format($cashier->amount_real, 2, ',', '.') }}</h4></td>
                                    </tr>
                                    <tr style="background-color: #E5E8E8">
                                        <td><h4>Saldo</h4></td>
                                        <td style="text-align: right"><h4 class="@if($cashier->balance > 0) text-success @endif @if($cashier->balance < 0) text-danger @endif">{{ number_format($cashier->balance, 2, ',', '.') }}</h4></td>
                                    </tr>
                                @endif
                            </table>
                        </div>
